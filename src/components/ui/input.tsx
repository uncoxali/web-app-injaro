    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={cn(
            "h-11 w-full rounded-lg border border-border bg-surface px-3 text-sm text-text-primary placeholder:text-text-secondary/60 outline-hidden transition-colors",
